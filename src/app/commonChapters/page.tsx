...
function EpisodeList({
  ...
  return (
    <ul
      data-testId={testId}
      className="max-h-[10%]  overflow-x-auto max-w-full flex md:block md:overflow-y-auto "
    >
    ...
    <div className="flex flex-col">
      ...
      <div className="flex flex-col md:flex-row place-content-between m-auto w-full">
        ...
        <div className="flex flex-col p-2 md:order-[0] order-[-1]">
          <p className="text-xl font-semibold mb-2 md:pt-[198px]">
            {" "}
            Episodios que comparten{" "}
          </p>
          {episodesInCommon && (
            <EpisodeList
              testId={"sharedEpisodes"}
              episodes={episodesInCommon}
            />
          )}
        </div>
